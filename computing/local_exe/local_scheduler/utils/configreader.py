...
class AppConfig:
    def __init__(self, config_path):
        ...
        self.post_datashape = eval(config["Application"]["PostDataShape"])
        ...
        self.post_data_size = int(config["Application"]["PostDataSize"])

        self.sensor_data_type = eval(config["Application"]["SensorDataType"])
        self.pre_data_type = eval(config["Application"]["PreDataType"])
        self.post_data_type = eval(config["Application"]["PostDataType"])
        self.posttime = float(config["Application"]["PostTime"])
        ...
        self.post_msgkey = int(config["Queue"]["post_msgkey"])
        self.post_start = int(config["Queue"]["post_Start"])
        ...
        self.engineinput = eval(config["Profile"]["engineInput"])
        self.engineoutput = eval(config["Profile"]["engineOutput"])
